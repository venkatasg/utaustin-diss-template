...
This template will automatically set the graduation month and year based on when you compile it. If needed, this can be changed at \texttt{\textbackslash{}graduation@month} in \\\texttt{styles/utformat.sty}.
